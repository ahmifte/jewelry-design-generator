...
from python_jewelry_design_gen.generators.meshy_api import MeshyAPI
from python_jewelry_design_gen.generators.meshy_api import MeshyAPIError
    ...
    def generate_design(
        ...
        try:
            ...
            raise JewelryGenerationError(
                f'Failed to generate design: {str(e)}',
            ) from e
